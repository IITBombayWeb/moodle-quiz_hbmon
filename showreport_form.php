 ...
 */
class showreport_form extends moodleform {
...
//         } else {
            $mform->addElement('static', 'description', '', 'Click here to view online users.');
            // Stop button.
            $mform->addElement('submit', 'submitbutton', 'Display report');
//         }
    }
}
